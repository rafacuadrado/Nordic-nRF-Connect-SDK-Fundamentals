...
const uintptr_t __irq_vector_table _irq_vector_table[69] = {
...
const struct _isr_table_entry __sw_isr_table _sw_isr_table[69] = {
	...
	{(const void *)0x20000034, (ISR)0x4901}, /* 13 */
