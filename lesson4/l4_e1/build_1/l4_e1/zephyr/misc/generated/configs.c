...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_FIXED_SUBPARTITIONS_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MPSL_FORCE_RRAM_ON_ALL_THE_TIME, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PSA_CRYPTO_PROVIDER_TFM, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NRF_GPIO1_PIN_MASK_SECURE, 0x00000003);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SOC_LATE_INIT_HOOK, 1);
